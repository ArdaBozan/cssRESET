...
function updatePriceLabel() {
    ...
    priceRange.style.background = `linear-gradient(to right, red ${percent}%, lightgray ${percent}%)`;
}
...
<div class="price-range-area grid gap-50">
        <p class="maxPrice-txt fw-semi-bold">En Yüksek Fiyat<span class="fw-normal">(günlük)</span></p>
